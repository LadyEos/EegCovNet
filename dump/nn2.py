...
def build_mlp(input_var=None):
    ...
    l_in = lasagne.layers.InputLayer(shape=(None, 1, 14, 2177),
                                     input_var=input_var)
...
def main(model='mlp', num_epochs=500):
    ...
    train_fn = theano.function([input_var, target_var], loss, updates=updates, name="train_fn")
